...
public class  HomeWork3 {
    ...
    public static String catchException(Integer integer) throws SocketException, ClassNotFoundException, AccessDeniedException, ExportException {
        try{
    ...
    public static void main(String[] args) throws SocketException, ClassNotFoundException, AccessDeniedException, ExportException {
        testFirstTask();
        testSecondTask();
    }
    ...
    public static void testSecondTask() throws SocketException, AccessDeniedException, ClassNotFoundException, ExportException {
